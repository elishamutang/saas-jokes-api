        ...
        $seedRolesAndPermissions = [
            ...
            [
                ...
                'permissions' => [
                    ...
                    'browse all users', 'read any user', 'edit client users only', 'create client users only', 'delete client users only',
                    ...
                    'reset client user passwords only', 'mark a client user as banned or suspended',
                    'revert a client user from suspended to active', 'browse soft-deleted categories', 'restore soft-deleted categories',
                    'browse soft-deleted jokes', 'restore soft-deleted jokes', 'browse soft-deleted client users', 'restore soft-deleted client users',
