...
test('client users cannot update a category', function() {
    ...
    // Update category
    $response = $this->putJson("/api/categories/$categoryId", $updatedData);
...
test('staff can recover all categories from trash', function() {
    ...
    $response = $this->postJson("/api/categories/trash/recover-all");
...
test('staff can recover one deleted category from trash', function() {
    ...
    // Restore categories from trash
    $response = $this->postJson("/api/categories/trash/recover/{$category->id}");
...
test('staff cannot remove all categories from trash', function() {
    ...
    $response = $this->postJson("/api/categories/trash/remove-all");
...
test('admin level and higher can remove one deleted category from trash', function() {
    ...
    // Remove categories from trash
    $response = $this->postJson("/api/categories/trash/remove/{$category->id}");
